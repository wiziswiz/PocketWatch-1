/**
 * Sweet Spot Database — known high-value award redemptions.
 * Used to flag when search results hit a sweet spot.
 */

import type { SweetSpot, SweetSpotMatch } from "@/types/travel"
...
export function matchSweetSpots(
  ...
  for (const spot of SWEET_SPOTS) {
    ...
    const pointsSaved = spot.maxPoints - points
