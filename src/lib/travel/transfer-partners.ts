/**
 * Transfer Partner Graph — maps bank points to airline programs.
 * Used to determine funding paths for award flights.
 */

import type { TransferPartner, FundingPath } from "@/types/travel"
...
export const TRANSFER_PARTNERS: TransferPartner[] = [
  ...
  // Marriott -> Airlines (3:1 ratio, +5K bonus per 60K)
